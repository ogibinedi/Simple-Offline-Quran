...
public class DetailListTafsirActivity extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle(getIntent().getStringExtra("detailNumber")+". "+getIntent().getStringExtra("detailTitle"));
    ...
    private void initWebView() {
        WebView webView = findViewById(R.id.wv_pengantar);
        ...
        String part_url = getIntent().getStringExtra("detailNumber");
        webView.loadUrl("file:///android_asset/tq/"+part_url+".html");
    }
