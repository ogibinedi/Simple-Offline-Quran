...
public class AlMulkActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "AlMulk";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_al_mulk);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Al-Mulk");
        toolbar.setSubtitle("Kerajaan - 30 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(AlMulkActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, AlMulkActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/almulk.json");
