...
public class AbAhActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ab_ah);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Tentang Asmaul Husna");
    ...
    private void initWebView() {
        WebView webView = findViewById(R.id.wv_ah);
        ...
        webView.loadUrl("file:///android_asset/ah/html/index.html");
    }
