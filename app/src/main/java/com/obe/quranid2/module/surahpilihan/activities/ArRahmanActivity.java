...
public class ArRahmanActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "ArRahman";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ar_rahman);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Ar-Rahman");
        toolbar.setSubtitle("Yang Maha Pengasih - 78 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(ArRahmanActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, ArRahmanActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/arrahman.json");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_goto){
            ...
            builder.setView(edtGoto)
                    ...
                    .setMessage("Masukan nomor ayat antara 1-78")
