...
public class AlBaqarahActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "AlBaqarah";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_al_baqarah);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Al-Baqarah");
        toolbar.setSubtitle("Sapi Betina - 286 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(AlBaqarahActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, AlBaqarahActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/al_baqarah.json");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_goto){
            ...
            builder.setView(edtGoto)
                    ...
                    .setMessage("Masukan nomor ayat antara 1-286")
