...
public class TentangHatiActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tentang_hati);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Tentang Penyakit Hati");
    ...
    private void initWebView() {
        WebView webView = findViewById(R.id.wv_th);
        ...
        webView.loadUrl("file:///android_asset/rq/public/tentang_penyakit_hati.html");
    }
