...
public class RqLongActivity extends AppCompatActivity {
    ...
    private static final String RQ_LONG_PREFS = "RqLong";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rq_long);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Bacaan Ruqyah Panjang");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                recyclerView = findViewById(R.id.rv_rq_long);
                recyclerView.setHasFixedSize(true);
                LinearLayoutManager layoutManager  = new LinearLayoutManager(getApplicationContext());
                recyclerView.setLayoutManager(layoutManager);
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(RqLongActivity.this){
                    @Override
                ...
                adapter = new RuqyahAdapter(ruqyahs, RqLongActivity.this);
                recyclerView.setAdapter(adapter);
                Handler handler = new Handler();
                handler.postDelayed(() -> pDialog.cancel(), 1000);

                // menampilkan posisi terakhir list pada saat dibuka kembali
                SharedPreferences getPrefs = getSharedPreferences(RQ_LONG_PREFS, MODE_PRIVATE);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("rq/rq_long.json");
