...
public class AlMuzammilActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "AlMuzammil";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_al_muzammil);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Al-Muzammil");
        toolbar.setSubtitle("Orang-orang Berselimut - 20 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(AlMuzammilActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, AlMuzammilActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/muzammil.json");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_goto){
            ...
            builder.setView(edtGoto)
                    ...
                    .setMessage("Masukan nomor ayat antara 1-20")
