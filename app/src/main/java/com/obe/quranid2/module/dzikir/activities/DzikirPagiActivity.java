...
public class DzikirPagiActivity extends AppCompatActivity {
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            try {
                ...
                // Fetch JSOnArray named DZIKIR_PAGI
                JSONArray dzikirPagiArray = obj.getJSONArray("pagi");
                // Getting dzikir list data
                for (int i=0; i < dzikirPagiArray.length(); i++){
                    Dzikir dzikir = new Dzikir();
                    // Fetch single dzikir data
                    JSONObject dzikirDetail = dzikirPagiArray.getJSONObject(i);
            ...
            runOnUiThread(() -> {
                recyclerView = findViewById(R.id.rv_dzikir_pagi);
                recyclerView.setHasFixedSize(true);
                LinearLayoutManager layoutManager  = new LinearLayoutManager(getApplicationContext());
                recyclerView.setLayoutManager(layoutManager);
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(DzikirPagiActivity.this){
                    @Override
                ...
                adapter = new DzikirAdapter(dzikirs, DzikirPagiActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("dzikir/dzikirpagi.json");
