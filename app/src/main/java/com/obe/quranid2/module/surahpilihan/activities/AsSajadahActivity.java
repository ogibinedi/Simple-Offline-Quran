...
public class AsSajadahActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "AsSajadah";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_as_sajadah);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah As-Sajadah");
        toolbar.setSubtitle("Sujud - 30 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(AsSajadahActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, AsSajadahActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/as_sajadah.json");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_goto){
            ...
            builder.setView(edtGoto)
                    ...
                    .setMessage("Masukan nomor ayat antara 1-30")
