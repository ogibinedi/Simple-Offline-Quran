...
public class AboutDzikirActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_about_dzikir);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Tentang Dzikir Pagi dan Sore");
    ...
    private void initWebView() {
        WebView webView = findViewById(R.id.wv_dpp);
        ...
        webView.loadUrl("file:///android_asset/dzikir/public/index.html");
    }
