...
public class JenisJenisSihirActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jenis_jenis_sihir);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Jenis Jenis Sihir");
    ...
    private void initWebView() {
        WebView webView = findViewById(R.id.wv_jjs);
        ...
        webView.loadUrl("file:///android_asset/rq/public/jenis_jenis_sihir.html");
    }
