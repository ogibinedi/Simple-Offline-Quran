...
public class AlhajjActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "AlHajj";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alhajj);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Al-Hajj");
        toolbar.setSubtitle("Haji - 78 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(AlhajjActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, AlhajjActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/al_hajj.json");
