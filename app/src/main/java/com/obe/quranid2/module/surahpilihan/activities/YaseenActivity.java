...
public class YaseenActivity extends AppCompatActivity {
    ...
    private static final String SURAH_PILIHAN_PREFS = "Yaseen";
    private LinearLayoutManager layoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yaseen);
    ...
    private void initToolbar() {
        ...
        toolbar.setTitle("Surah Yaseen");
        toolbar.setSubtitle("Yasiin - 83 Ayat");
    ...
    private void getTheData(){
        ...
        service.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                RecyclerView.SmoothScroller smoothScroller = new LinearSmoothScroller(YaseenActivity.this){
                    @Override
                ...
                adapter = new SurahPilihanAdapter(surahs, YaseenActivity.this);
    ...
    private String loadJSONfromAssets() {
        ...
        try{
            InputStream is = getAssets().open("sp/yaseen.json");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_goto){
            ...
            builder.setView(edtGoto)
                    ...
                    .setMessage("Masukan nomor ayat antara 1-83")
